...
export const translations = {
  en: {
    ...
    modelConfigInfo2: '• Base URL can be configured for all models (proxy/custom server, leave blank for official)',
    modelConfigInfo3: '• Model Name is required only for Custom API, DeepSeek/Qwen use default values',
  ...
  zh: {
    ...
    modelConfigInfo2: '• Base URL可为所有模型配置代理或自定义服务器（留空使用官方地址）',
    modelConfigInfo3: '• Model Name仅Custom API必填，DeepSeek/Qwen会使用默认值',
    saveConfig: '保存配置',
    editExchange: '编辑交易所',
    addExchange: '添加交易所',
